                ...
                <ul className="navbar-nav">
                  <li className="nav-item dropdown">
                    ...
                    >
                      ...
                      {this.props.t("General")} {this.props.menuOpen}
                      <div className="arrow-down" />
                    </Link>
                    <div
                      className={classname("dropdown-menu", {
                        show: this.state.isGeneral,
                      })}
                    >
                      <Link to="/grid/ssl" className="dropdown-item">
                        {this.props.t("SSL Certificates")}
                      </Link>
                      <Link to="/grid/rtExceptions" className="dropdown-item">
                  ...
                  <li className="nav-item dropdown">
                    <Link
                      ...
                      onClick={e => {
                        e.preventDefault();
                        this.setState({ isPayments: !this.state.isPayments });
                      }}
                      to="/#"
                    >
                      <i className="bx bx-home-circle me-2" />
                      {this.props.t("Payments")} {this.props.menuOpen}
                      <div className="arrow-down" />
                    </Link>
                    <div
                      className={classname("dropdown-menu", {
                        show: this.state.isPayments,
                      })}
                    >
                      <Link to="/grid/achInbound" className="dropdown-item">
                        {this.props.t("ACH Inbound")}
                      </Link>
                      <Link to="/grid/achOutbound" className="dropdown-item">
                        {this.props.t("ACH Outbound")}
                      </Link>
                      <Link to="/grid/bulk" className="dropdown-item">
                        {this.props.t("Bulk Payment Files")}
                      </Link>
                      <Link to="/grid/blotterStuck" className="dropdown-item">
                        {this.props.t("Stuck in Payment Blotter")}
                      </Link>
                      <Link to="/grid/achStuck" className="dropdown-item">
                        {this.props.t("Stuck in ACH")}
                      </Link>
                      <Link to="/grid/wireStuck" className="dropdown-item">
                        {this.props.t("Stuck in WIRE")}
                      </Link>
                    </div>
                  </li>
