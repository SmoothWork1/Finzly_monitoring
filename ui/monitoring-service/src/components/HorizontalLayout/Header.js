                ...
                <DropdownMenu className="dropdown-menu-lg dropdown-menu-end">
                  <div className="px-lg-2">
                    <Row className="no-gutters">
                      <Col>
                        <a rel="noreferrer" className="dropdown-icon-item" href="https://github.com/" target="_blank">
                          <img src={github} alt="Github" />
                          <span>GitHub</span>
                        </a>
                      </Col>
                      <Col>
                        <a rel="noreferrer" className="dropdown-icon-item" href="https://aws.amazon.com/" target="_blank">
                          <img src={bitbucket} alt="bitbucket" />
                          <span>Logs</span>
                        </a>
                      </Col>
                      <Col>
                        <a rel="noreferrer" className="dropdown-icon-item" href="https://swapstech.atlassian.net/wiki/home" target="_blank">
                    ...
                    <Row className="no-gutters">
                      ...
                      <Col>
                        <a rel="noreferrer" className="dropdown-icon-item" href="https://swapstech.atlassian.net/" target="_blank">
                          <img src={jira} alt="jira" />
                          <span>Jira</span>
                        </a>
                      </Col>
                      <Col>
                        <a rel="noreferrer" className="dropdown-icon-item" href="https://cert.finzly.net/apiclient/index.jsp#/Settings/MailServer" target="_blank">
